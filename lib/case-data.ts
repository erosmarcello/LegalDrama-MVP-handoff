    ...
    sections: [
      {
        id: "ch4-s1",
        type: "scene",
        content: "INT. COURTROOM - S.D.N.Y. - DAY\n\nJUDGE MARY M. GENTRY takes the bench. The courtroom falls silent. This is the moment that will shape the trial.",
...
export const FULL_DOCKET_ENTRIES: DocketEntry[] = [
  ...
  { number: 32, date: "05/15/2025", text: "MOTION to Appoint Additional Counsel for capital case by Luigi Nicholas Mangione.", type: "motion", tier: 2 },
  { number: 35, date: "05/29/2025", text: "ORDER granting Motion to Appoint Additional Counsel. Marc Agnifilo admitted pro hac vice.", type: "order", tier: 2 },
  { number: 40, date: "07/10/2025", text: "SEALED MOTION filed by USA. [Redacted content]", type: "motion", tier: 3 },
  { number: 45, date: "08/15/2025", text: "MOTION for Bill of Particulars by Luigi Nicholas Mangione.", type: "motion", tier: 2 },
  { number: 48, date: "09/01/2025", text: "RESPONSE to Motion for Bill of Particulars filed by USA.", type: "filing", tier: 3 },
  { number: 51, date: "09/20/2025", text: "MOTION TO DISMISS INDICTMENT by Luigi Nicholas Mangione. Constitutional challenge to stalking statute as applied.", type: "motion", tier: 1, starred: true },
  { number: 54, date: "10/01/2025", text: "RESPONSE in Opposition to Motion to Dismiss filed by USA.", type: "filing", tier: 2 },
  { number: 57, date: "10/08/2025", text: "REPLY in Support of Motion to Dismiss by Luigi Nicholas Mangione.", type: "filing", tier: 2 },
  { number: 59, date: "10/11/2025", text: "MOTION TO SUPPRESS EVIDENCE by Luigi Nicholas Mangione. Challenges warrantless arrest and subsequent search.", type: "motion", tier: 1, starred: true },
  { number: 62, date: "10/25/2025", text: "RESPONSE in Opposition to Motion to Suppress filed by USA.", type: "filing", tier: 2 },
  { number: 65, date: "11/05/2025", text: "REPLY in Support of Motion to Suppress by Luigi Nicholas Mangione.", type: "filing", tier: 2 },
  { number: 70, date: "11/20/2025", text: "Minute Entry: Oral Argument on pending motions. Court takes matters under advisement.", type: "hearing", tier: 2 },
  { number: 75, date: "12/10/2025", text: "ORDER setting evidentiary hearing on suppression motion for January 23, 2026.", type: "order", tier: 2 },
  { number: 80, date: "01/10/2026", text: "WITNESS LIST for suppression hearing filed by USA.", type: "filing", tier: 3 },
  { number: 85, date: "01/15/2026", text: "WITNESS LIST for suppression hearing filed by Luigi Nicholas Mangione.", type: "filing", tier: 3 },
  { number: 90, date: "01/23/2026", text: "Minute Entry: Suppression Hearing Day 1. Government witnesses testify regarding arrest circumstances.", type: "hearing", tier: 1 },
  { number: 95, date: "01/24/2026", text: "Minute Entry: Suppression Hearing Day 2. Defense cross-examination. Hearing concluded.", type: "hearing", tier: 1 },
  { number: 100, date: "01/28/2026", text: "POST-HEARING BRIEF filed by Luigi Nicholas Mangione.", type: "filing", tier: 2 },
  { number: 101, date: "01/29/2026", text: "POST-HEARING BRIEF filed by USA.", type: "filing", tier: 2 },
  { number: 102, date: "01/30/2026", text: "MEMORANDUM OPINION AND ORDER denying Motion to Suppress. Court finds stop and search lawful under totality of circumstances.", type: "order", tier: 1, starred: true },
  { number: 103, date: "01/30/2026", text: "MEMORANDUM OPINION AND ORDER granting in part Motion to Dismiss. Counts 3 and 4 DISMISSED for insufficient federal nexus. Counts 1 and 2 remain.", type: "order", tier: 1, starred: true },
  { number: 105, date: "02/03/2026", text: "MASTER SCHEDULING ORDER. Sets 14 trial preparation deadlines. Trial to commence October 13, 2026.", type: "order", tier: 1, starred: true },
  { number: 108, date: "02/15/2026", text: "MOTION for Reconsideration of suppression ruling by Luigi Nicholas Mangione.", type: "motion", tier: 2 },
  { number: 110, date: "02/20/2026", text: "RESPONSE in Opposition to Motion for Reconsideration filed by USA.", type: "filing", tier: 3 },
  { number: 112, date: "02/25/2026", text: "ORDER denying Motion for Reconsideration. Court adheres to prior ruling.", type: "order", tier: 2 },
  { number: 113, date: "02/27/2026", text: "NOTICE OF WITHDRAWAL OF DEATH PENALTY filed by USA. Government no longer seeks capital punishment.", type: "notice", tier: 1, starred: true },
  { number: 115, date: "03/05/2026", text: "JOINT STATUS REPORT filed by parties regarding discovery progress.", type: "filing", tier: 3 },
  { number: 118, date: "03/12/2026", text: "MOTION in Limine No. 1 by USA. Seeks to admit manifesto and related writings.", type: "motion", tier: 2 },
  { number: 120, date: "03/18/2026", text: "MOTION TO CONTINUE TRIAL by Luigi Nicholas Mangione. Seeks 90-day postponement.", type: "motion", tier: 2 },
  { number: 123, date: "03/23/2026", text: "ORDER setting conference for April 1, 2026 to address continuance motion.", type: "order", tier: 2 },
]
...
export const TIMELINE_EVENTS = [
  ...
  { id: "f4", lane: "factual" as const, date: "2025-04-24", title: "Death Penalty Notice", description: "Government seeks capital punishment", tier: 1, docketNum: 25 },
  { id: "p3", lane: "procedural" as const, date: "2025-04-25", title: "Arraignment", description: "Not guilty plea entered", tier: 1, docketNum: 28 },
  { id: "p4", lane: "procedural" as const, date: "2025-09-20", title: "Motion to Dismiss", description: "Constitutional challenge filed", tier: 2, docketNum: 51 },
  { id: "p5", lane: "procedural" as const, date: "2025-10-11", title: "Suppression Motion", description: "Challenge to arrest/search", tier: 2, docketNum: 59 },
  { id: "p6", lane: "procedural" as const, date: "2026-01-23", title: "Suppression Hearing", description: "Two-day evidentiary hearing", tier: 1, docketNum: 90 },
  { id: "f5", lane: "factual" as const, date: "2026-01-30", title: "Suppression Denied", description: "Evidence remains admissible", tier: 1, docketNum: 102 },
  { id: "f6", lane: "factual" as const, date: "2026-01-30", title: "Counts Dismissed", description: "Murder counts 3 & 4 thrown out", tier: 1, docketNum: 103 },
  { id: "s1", lane: "scheduling" as const, date: "2026-02-03", title: "Master Schedule", description: "14 trial prep deadlines set", tier: 1, docketNum: 105 },
  { id: "f7", lane: "factual" as const, date: "2026-02-27", title: "Death Penalty Dropped", description: "Government withdraws DP notice", tier: 1, docketNum: 113 },
  ...
  { id: "n1", lane: "narrative" as const, date: "2026-10-13", title: "TRIAL BEGINS", description: "Opening statements", tier: 1 },
]
...
export const ASSET_LIBRARY: Asset[] = [
  ...
  { id: "au5", name: "Courtroom Audio — Ruling Announcement", category: "audio", date: "01/30/2026", uploader: "Court AV", linkedEntries: ["Dkt 102", "Dkt 103"], starred: true, pinned: false, audioDuration: "22:08", description: "Judge Gentry reads suppression and dismissal rulings" },
]
